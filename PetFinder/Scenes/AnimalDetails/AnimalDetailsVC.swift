...
class AnimalDetailsVC: UIViewController {
    ...
    init(viewModel: AnimalDetailsVM) {
        self.viewModel = viewModel
        super.init(nibName: nil, bundle: nil)
    }
    
    private let viewModel: AnimalDetailsVM
...
extension AnimalDetailsVC: MFMailComposeViewControllerDelegate {
...
extension AnimalDetailsVC: UICollectionViewDataSource {
...
extension AnimalDetailsVC: UICollectionViewDelegateFlowLayout {
    func collectionView(
